...
**Intent**: Implement features for roles: ['build driving school management', 'student', 'instructor']. Archetypes: ['fullstack', 'mobile_hybrid']
**Archetypes**: fullstack, mobile_hybrid | **Scope**: MAJOR
**Gate Result**: BLOCKED (Assumption Weight: 50/40)
**Total Requirements**: 320 | **Version**: v1
