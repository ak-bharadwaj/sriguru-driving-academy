// Static learning card content — served without any DB query.
// Only student progress (completed/quizPassed) is stored in DB.
// This saves ~10 Neon queries per student visit.

export interface LearningCardData {
  slug: string
  title: string
  category: string
  phase: 'BEGINNER' | 'INTERMEDIATE' | 'ADVANCED' | 'RTO' | 'MASTERY'
  xpReward: number
  orderIndex: number
  steps: string[]
...
export const LEARNING_CARDS: LearningCardData[] = [
  {
