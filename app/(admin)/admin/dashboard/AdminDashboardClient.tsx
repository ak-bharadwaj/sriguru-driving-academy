...
const ADMIN_DICT = {
  EN: {
    ...
    cmdCenter: "Manage your students, instructors, and driving bookings.",
    ...
    waiting: "waiting",
    inboxZero: "All bookings processed. No new registrations waiting.",
    reviewApprove: "Review & Approve",
    recentActivity: "Recent Activity",
    engagementTrends: "Student Practice Activity",
    last7Days: "Last 7 Days",
    students: "students",
    xp: "XP",
    topStudents: "Top Students",
    level: "Level",
    instructorLoad: "Instructor Workload (Sessions this week)",
    sessWk: "sess/wk",
  ...
  HI: {
    ...
    cmdCenter: "अपने छात्रों, प्रशिक्षकों और ड्राइविंग बुकिंग का प्रबंधन करें।",
    ...
    waiting: "प्रतीक्षारत",
    inboxZero: "सभी बुकिंग संसाधित। कोई नया पंजीकरण प्रतीक्षा में नहीं है।",
    reviewApprove: "समीक्षा और अनुमोदन",
    recentActivity: "हाल की गतिविधि",
    engagementTrends: "छात्र अभ्यास गतिविधि",
    last7Days: "पिछले 7 दिन",
    students: "छात्र",
    xp: "एक्सपी",
    topStudents: "शीर्ष छात्र",
    level: "स्तर",
    instructorLoad: "प्रशिक्षक कार्यभार (इस सप्ताह के सत्र)",
    sessWk: "सत्र/सप्ताह",
  ...
  TE: {
    adminWorkspace: "అడ్మిన్ వర్క్స్పేస్",
    academyHQ: "అకాడమీ HQ",
    cmdCenter: "మీ విద్యార్థులను, శిక్షకులను మరియు డ్రైవింగ్ బుకింగ్‌లను నిర్వహించండి.",
    ...
    waiting: "వేచి ఉంది",
    inboxZero: "అన్ని బుకింగ్‌లు ప్రాసెస్ చేయబడ్డాయి. కొత్త రిజిస్ట్రేషన్లు ఏవీ లేవు.",
    reviewApprove: "సమీక్షించి ఆమోదించండి",
    recentActivity: "ఇటీవలి కార్యాచరణ",
    engagementTrends: "విద్యార్థుల సాధన కార్యాచరణ",
    last7Days: "గత 7 రోజులు",
    students: "విద్యార్థులు",
    xp: "XP",
    topStudents: "టాప్ విద్యార్థులు",
    level: "స్థాయి",
    instructorLoad: "బోధకుని పనిభారం (ఈ వారం సెషన్‌లు)",
    sessWk: "సెస్/వారం",
