    ...
    <div className="min-h-screen bg-void text-text-1 font-body p-4 sm:p-6 md:p-12 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto z-10 relative">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold mb-2">Coaching Notes</h1>
            <p className="text-sm sm:text-base text-text-2">Per-session notes for your students.</p>
          </div>
          <button 
        ...
        {loading ? (
          ...
          <div className="py-20 text-center border border-border border-dashed rounded-2xl bg-surface/50">
            ...
            <h3 className="text-lg font-semibold text-text-1 mb-2">No Notes Found</h3>
            <p className="text-text-3">You haven't recorded any coaching notes yet.</p>
          </div>
        ) : (
          ...
          >
            ...
            >
              <div className="p-5 border-b border-border flex justify-between items-center bg-void/50">
                <h3 className="font-bold text-lg text-white">Add Coaching Note</h3>
              ...
              <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-bold text-text-2 uppercase tracking-wider">Select Session (Optional)</label>
                  <select 
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-bold text-text-2 uppercase tracking-wider">Note Content</label>
                  <textarea 
                    required
                    rows={6}
                    placeholder="E.g., Needs more practice with parallel parking..."
