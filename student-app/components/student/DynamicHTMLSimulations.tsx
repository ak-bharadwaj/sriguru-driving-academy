...
export const RealisticSideProfileSVG = ({ speed = 0, step = 0 }: { speed?: number, step?: number }) => {
  ...
  const spinDuration = `${Math.max(0.2, 1.5 - speed * 0.05)}s`

  return (
    <div className="relative w-[140px] h-[55px]">
      <svg width="140" height="55" viewBox="0 0 140 55" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-xl absolute inset-0">
        <defs>
        ...
        <ellipse cx="70" cy="46" rx="60" ry="5" fill="rgba(0,0,0,0.5)" />

        {/* Car Body Silhouette */}
        {/* Rear bumper, trunk, roof, hood, front bumper, underskirt */}
        <path d="M 6 36 
                 C 2 36, 1 32, 2 28 
                 C 3 24, 7 24, 12 24 
                 C 14 20, 20 12, 34 10 
                 C 42 8, 50 4, 65 4 
                 L 90 4 
                 C 105 4, 115 12, 122 18 
                 L 134 22 
                 C 137 23, 139 26, 138 29 
                 C 137 32, 135 36, 128 36 
                 L 124 36
                 C 124 31, 112 31, 112 36
                 L 44 36
                 C 44 31, 32 31, 32 36
                 Z" 
              fill="url(#carBodyGrad)" stroke="#1e293b" strokeWidth="1.5" />
        ...
        <path d="M 37 12 
                 ...
                 L 35 18 
                 Z" 
              fill="url(#glassGrad)" stroke="#334155" strokeWidth="1" />
        <path d="M 70 7 
                 L 88 7 
                 C 100 7, 108 14, 113 18 
                 L 70 18 
                 Z" 
              fill="url(#glassGrad)" stroke="#334155" strokeWidth="1" />

        {/* Side Mirror */}
        <path d="M 64 17 C 61 17, 60 15, 62 14 L 66 14 C 67 14, 68 15, 67 17 Z" fill="#334155" />

        {/* Door Panels / Lines */}
        <path d="M 68 7 L 68 36" stroke="#1e293b" strokeWidth="1" />
        <path d="M 34 20 L 34 36" stroke="#1e293b" strokeWidth="1" />
        <path d="M 102 20 C 105 23, 107 28, 110 36" stroke="#1e293b" strokeWidth="1" />
        
        {/* Door Handles */}
        <rect x="58" y="22" width="7" height="2" rx="0.5" fill="#e2e8f0" stroke="#475569" strokeWidth="0.5" />
        <rect x="74" y="22" width="7" height="2" rx="0.5" fill="#e2e8f0" stroke="#475569" strokeWidth="0.5" />

        {/* Headlight (front) */}
        <path d="M 134 23 C 137 24, 138 27, 137 29 L 133 28 Z" fill="#fef08a" filter="drop-shadow(2px 0px 4px #fef08a)" />
        {/* Taillight (rear) */}
        <path d="M 4 25 C 2 25, 2 28, 4 30 L 8 29 Z" fill="#ef4444" />

        {/* Wheel Arches */}
        <path d="M 23 36 C 23 27, 43 27, 43 36" stroke="#1e293b" strokeWidth="2" fill="none" />
        <path d="M 103 36 C 103 27, 123 27, 123 36" stroke="#1e293b" strokeWidth="2" fill="none" />

        {/* Outer Tires */}
        <circle cx="33" cy="36" r="11" fill="#0f172a" stroke="#1e293b" strokeWidth="1" />
        <circle cx="113" cy="36" r="11" fill="#0f172a" stroke="#1e293b" strokeWidth="1" />

        {/* Alloy Wheels Hub */}
        <circle cx="33" cy="36" r="7.5" fill="url(#wheelGrad)" />
        <circle cx="113" cy="36" r="7.5" fill="url(#wheelGrad)" />
      </svg>

      {/* Rotating Spokes Overlay using absolute divs for smooth CSS rotation */}
      <div 
        className={`absolute w-[13px] h-[13px] rounded-full flex items-center justify-center`}
        style={{
          left: '26.5px',
          top: '29.5px',
      ...
      >
        <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
          <circle cx="6.5" cy="6.5" r="6" stroke="#475569" strokeWidth="0.5" />
          <line x1="6.5" y1="0.5" x2="6.5" y2="12.5" stroke="#cbd5e1" strokeWidth="1" />
          <line x1="0.5" y1="6.5" x2="12.5" y2="6.5" stroke="#cbd5e1" strokeWidth="1" />
          <line x1="2.26" y1="2.26" x2="10.74" y2="10.74" stroke="#cbd5e1" strokeWidth="1" />
          <line x1="2.26" y1="10.74" x2="10.74" y2="2.26" stroke="#cbd5e1" strokeWidth="1" />
          <circle cx="6.5" cy="6.5" r="1.5" fill="#64748b" />
        </svg>
      </div>
