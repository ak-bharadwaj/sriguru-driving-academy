      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full right-0 mt-2 p-2 w-32 bg-surface/90 backdrop-blur-xl border border-border rounded-2xl shadow-2xl flex flex-col gap-1 z-[1100]"
          >
            {LANGUAGES.map((lang) => (
              <button
                key={lang.code}
