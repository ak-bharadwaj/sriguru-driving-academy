      ...
      <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
        ...
        >
          ...
          >
            ...
            <div className="w-[100px] h-[100px] rounded-full bg-accent/10 border-2 border-accent/40 flex items-center justify-center text-accent relative z-10 overflow-hidden">
              {pendingBadgeReveal.customImage ? (
                <img src={pendingBadgeReveal.customImage} alt={pendingBadgeReveal.name} className="w-full h-full object-cover" />
              ) : (
